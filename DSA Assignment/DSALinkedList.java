 ...
 *		        Repurposed from my DSALinkedList file submitted to practicals            *
 *****************************************************************************************/
import java.util.*;
import java.io.*;
...
public class DSALinkedList implements Iterable
{
    ...
    // Method to check if a node contains a target value
    public boolean contains(Object value)
	{
	    boolean found = false;
	    DSAListNode currNode = head;
	    
        while (currNode != null && !found) // Moves through the list until value found or reached null
	    {
    ...
    // Returns a new instance of DSALinkedList iterator
